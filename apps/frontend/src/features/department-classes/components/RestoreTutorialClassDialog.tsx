...
type RestoreTutorialClassDialogProps = {
...
export function RestoreTutorialClassDialog({
  tutorialClass,
  isSubmitting,
  onOpenChange,
  onConfirm,
}: RestoreTutorialClassDialogProps) {
  return (
    <AlertDialog
    ...
    >
      <AlertDialogContent>
        <AlertDialogHeader>
          <AlertDialogTitle>Khôi phục lớp phụ đạo</AlertDialogTitle>
          <AlertDialogDescription>
            {tutorialClass
              ? `Bạn có chắc muốn khôi phục lớp phụ đạo môn "${tutorialClass.courseName}"?`
              : ''}
          </AlertDialogDescription>
        </AlertDialogHeader>
        <AlertDialogFooter>
          ...
          >
            {isSubmitting ? 'Đang xử lý...' : 'Xác nhận khôi phục'}
          </AlertDialogAction>
        </AlertDialogFooter>
      </AlertDialogContent>
    </AlertDialog>
